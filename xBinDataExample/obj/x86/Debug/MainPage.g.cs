#pragma checksum "D:\MS\xBinDataExample\xBinDataExample\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "06EBE7CAF4AB70F7B899E95E2A05561D"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace xBinDataExample
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj2_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBinDataExample.Models.Book dataRoot;
            ...
            {
                 global::xBinDataExample.Models.Book data = args.NewValue as global::xBinDataExample.Models.Book;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::xBinDataExample.Models.Book was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::xBinDataExample.Models.Book);
                ...
                this.Update_((global::xBinDataExample.Models.Book) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::xBinDataExample.Models.Book newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::xBinDataExample.Models.Book obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBinDataExample.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void SetDataRoot(global::xBinDataExample.MainPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::xBinDataExample.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Books(global::System.Collections.Generic.List<global::xBinDataExample.Models.Book> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 2:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::xBinDataExample.Models.Book) element2.DataContext);
